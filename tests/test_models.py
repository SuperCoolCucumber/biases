...
from biases.models import ChatTemplatePolicy, available_model_names, get_model_profile
...
def test_olmo3_profile_uses_the_pinned_tokenizer_prompt_contract() -> None:
    profile = get_model_profile("olmo3-7b-instruct")

    assert profile.hf_model_name == "allenai/Olmo-3-7B-Instruct"
    assert profile.family == "olmo3"
    assert profile.revision == "6e5971d9eba42665f5bd5a0fcf047f299ce1dccc"
    assert profile.chat_template is ChatTemplatePolicy.TOKENIZER
